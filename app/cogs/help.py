...
class Help(commands.Cog):
    ...
    async def help(self,ctx,*args):
        embed = discord.Embed(
            ...
            color = 0xfcba03,
            description=f"Optional parameters are *italicized*."
        )
        ...
        embed.add_field(name="t.character (character)", value="View the information of a specific character.", inline="True")
